...
export type CreateTopicMutation = { __typename?: 'Mutation', createTopic: { __typename?: 'Topic', _id: string, name: string, key: string, context?: string | null | undefined, isDisambiguation?: boolean | null | undefined, description?: string | null | undefined, descriptionSourceUrl?: string | null | undefined, wikipediaPageUrl?: string | null | undefined, aliases?: Array<string> | null | undefined, level?: number | null | undefined, createdAt: any } };
