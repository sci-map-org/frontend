    ...
    <Box width={['100%', '90%', '80%', '70%']}>
      ...
      <Box p={5}>
        <Text>
          ...
          free, personalized learning experience for any topic and allowing learners to explore knowledge intuitively.
          As of August 2020, it is in a state of semi-private release.
      ...
      <Stack direction="column" spacing={6}>
        ...
        <Stack direction="row" spacing={16}>
          <Flex direction="column" justifyContent="center">
            ...
            <Text>
              ...
              for each user, <b>Sci-map.org</b> aims to be the perfect tool for continuous learning across a wide range
              of domains.
            </Text>
          </Flex>
        ...
        <Stack direction="row" spacing={16}>
          ...
          <Flex direction="column" justifyContent="center">
            ...
            <Text>
              This project is community-based: we intend to build this modeling of the knowledge space, assess the
              content quality, and improve upon it collaboratively. <br />
              We aim to enable communities to form around different domains, foster learning with peers, receiving
      ...
      <Box mt={10} mb={20}>
        ...
        <Text>
          The project is currently in a semi-private release (the name will change) in order to gather feedback and
          start improving it iteratively. It is open-source (checkout{' '}
          ...
          . The first version of the product consists of a recommendation feed of external learning resources, based on
          a mapping of the dependencies between concepts and the current knowledge of the learner. Our first goal is to
          support learners by indexing free external learning resources and serving it in a valuable way
          (recommendations, learning paths, etc.). We then plan to integrate feedback, develop social features, and
          drive contributions towards user-generated content.
          <br />
          ...
          to bring it to life. At the current stage, feedback is highly valuable. Please let us know what you think on
          the{' '}
