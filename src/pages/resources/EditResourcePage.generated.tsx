...
export type GetResourceEditResourcePageQuery = { __typename?: 'Query' } & {
 ...
 * });
 */
export function useGetResourceEditResourcePageQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    GetResourceEditResourcePageQuery,
    GetResourceEditResourcePageQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<GetResourceEditResourcePageQuery, GetResourceEditResourcePageQueryVariables>(
    Operations.getResourceEditResourcePage,
    baseOptions
  );
}
export function useGetResourceEditResourcePageLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetResourceEditResourcePageQuery,
    GetResourceEditResourcePageQueryVariables
  >
) {
  return ApolloReactHooks.useLazyQuery<GetResourceEditResourcePageQuery, GetResourceEditResourcePageQueryVariables>(
    Operations.getResourceEditResourcePage,
    baseOptions
  );
}
...
export type GetResourceEditResourcePageQueryResult = ApolloReactCommon.QueryResult<
  GetResourceEditResourcePageQuery,
  GetResourceEditResourcePageQueryVariables
>;
